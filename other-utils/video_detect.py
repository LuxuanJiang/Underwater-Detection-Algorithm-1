...
# Usage example:  python3 video_detect.py --video=run.mp4
#                 python3 video_detect.py --image=bird.jpg
...
# Load names of classes # 加载类别
classesFile = "data/custom/classes.names"
classes = None
...
# 加载配置和权重
modelConfiguration = "config/yolov3-custom.cfg"
...
def drawPred(classId, conf, left, top, right, bottom):
    ...
    if classes:
        ...
        label = '%s:%s' % (classes[classId], label) # 方框上显示类别和标签
